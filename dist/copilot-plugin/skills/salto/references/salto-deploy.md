...
- Read `./adapters/<adapter>/<adapter>.md` into context (using your file-reading capability — these files are bundled with the skill, so resolve the path relative to the skill, not the current working directory).
